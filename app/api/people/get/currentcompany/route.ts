...
export async function POST(req: Request) {
    ...
    const candidateJurPeople = await sql`SELECT juridical_person.id, streets.name as street_name, place_house, place_room, organization_name, director_name, director_phone_number
