...
export async function GET(req: Request) {
    ...
    const companyDrivers = (await sql`SELECT company_driver.id, first_name, last_name, patronymic, passport_series, passport_number, juridical_person.Organization_name as organization_name
