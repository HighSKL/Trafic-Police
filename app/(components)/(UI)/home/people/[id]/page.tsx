...
import { ChangeDataCars, ChangeDataInspection, GetCurrPeople, GetCurrentInspection, deleteCar, getCurrCar } from '@/app/modules/apiservice';
...
export default function ShowInfoPeopleBlock({ params: { id } }: any) {
    ...
    const fields = [
        ...
        // { title: "Автомобили во владении", errorMessage: "Укажите автомобили во владении", name: "OwnCar"},
